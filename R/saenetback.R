                                ...
                                pf, adWeight, maxit, eps)
{
  ...
  fit.model <- function(L1, L2, start)
  {
    ...
    while (max(abs(beta - beta.old)) > eps && it < maxit) {
     ...
     mu <- c(0.0344208231,  0.0325402148,  0.0294049421,  0.0185765051, -0.0101623364,  0.0782674679,  0.0962623044,  0.0446506022,
  -0.0389159806,  0.0219312139, -0.0560615093, -0.0455519354,  0.0106625297,  0.0352796766, -0.0148829599, -0.0546216888,
 0.1043605054, -0.0003041273, -0.1187417639, -0.0823640847)
     sd <- c(2.124153, 2.145554, 2.174286, 2.228405, 2.096970, 2.253777, 2.298902, 2.370947, 2.499281, 2.187748, 2.276929, 2.346313,
 2.124660, 2.247629, 2.235509, 2.306097, 2.476394, 2.140023, 2.437744, 2.433888)
