...
#' 
#' @export
saenetback <- function(x, y, pf, adWeight, weights, family = c("gaussian", "binomial"),
                                ...
                                pf, adWeight, maxit, eps)
{
  ...
  fit.model <- function(L1, L2, start)
  {
    ...
    mu<-c(0.4866667, 0.4966667, 0.4833333, 0.5160000, 0.4853333, 0.4926667, 0.5340000, 0.4753333, 0.4660000, 0.4706667, 0.5280000,
 0.4906667, 0.4886667, 0.4920000, 0.5120000, 0.4946667, 0.5000000, 0.4846667, 0.4473333, 0.5186667)
    sd<-c(1.118009, 1.118382, 1.117785, 1.117834, 1.117926, 1.118287, 1.115818, 1.117045, 1.115818, 1.116481, 1.116652, 1.118212,
 1.118120, 1.118264, 1.118085, 1.118343, 1.118407, 1.117881, 1.112185, 1.117627)
    # mu <- c(0.034468215,  0.030994255,  0.033178200,  0.017966724, -0.023300867,  0.078683746,  0.124141617,  0.009693279,
 # -0.053388270,  0.037917731, -0.065143648, -0.024505257,  0.011958330,  0.018861848, -0.024560295, -0.051131994,
 # 0.118918042, -0.041242395, -0.131370845, -0.136537330)
    # sd <- c(2.132421, 2.145975, 2.174722, 2.219319, 2.118904, 2.269696, 2.279349, 2.362778, 2.449861, 2.241856, 2.301639, 2.330267,
# 2.137372, 2.273023, 2.269924, 2.323819, 2.426431, 2.113099, 2.408566, 2.473285)
